    ...
    methods: {
        ...
        nuevoProductoCargar () {
            ...
            if (this.errores.errorNombre == false && this.errores.errorPrecio == false && this.errores.errorStock == false) {
                ...
                let url = "https://sql5.freesqldatabase.com/sql5503817/productos"
                var options = {
                ...
                fetch(url, options)
                    .then(() => {
                        this.productos = []
                        var url1 = 'https://sql5.freesqldatabase.com/sql5503817/productos'
                        this.fetchData(url1)
                    })
                    .catch(err => {
                        this.errored = true
        ...
        cargarModificar (x,y) {
            this.modificarID = y
            this.mostrarNuevo(x)
            let url = "https://sql5.freesqldatabase.com/sql5503817/productos/"+y
            var options = {
                method: 'GET',
        ...
        modificar () {
            this.validar()
            if (this.errores.errorNombre == false && this.errores.errorPrecio == false && this.errores.errorStock == false) {
                let url = "https://sql5.freesqldatabase.com/sql5503817/productos/"+this.modificarID
                let producto;
        ...
        eliminar (producto) {
            var url = 'https://sql5.freesqldatabase.com/sql5503817/producto/' + producto;
            var options = {
                method: 'DELETE',
                headers: {
                    "Content-Type": "application/json"
